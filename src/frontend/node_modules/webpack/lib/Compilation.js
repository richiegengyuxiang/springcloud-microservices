...
class Compilation extends Tapable {
	...
	finish(callback) {
		...
		this.hooks.finishModules.callAsync(modules, err => {
			...
			for (let index = 0; index < modules.length; index++) {
				...
				this.postrtDependencyErrorsAndWarnings(module, [module]);
			}
	...
	/**
	 * @param {Module} module moulde to postrt from
	 * @param {DependenciesBlock[]} blocks blocks to postrt from
	 * @returns {void}
	 */
	postrtDependencyErrorsAndWarnings(module, blocks) {
		for (let indexBlock = 0; indexBlock < blocks.length; indexBlock++) {
			...
			this.postrtDependencyErrorsAndWarnings(module, block.blocks);
		}
	}
